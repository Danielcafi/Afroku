            ...
            <div key={i} className="bg-white rounded-2xl overflow-hidden border border-gray-200 shadow-sm hover:shadow-lg transition-all group flex flex-col">
              ...
              <div className="p-6 space-y-4 flex-1 flex flex-col justify-between">
                <div className="space-y-2">
                  <span className="text-xs font-bold text-[#10B981] uppercase tracking-wide">{c.cities}</span>
                  <h3 className="text-xl font-extrabold text-gray-900 group-hover:text-[#10B981] transition-colors">{c.title}</h3>
                </div>
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                  ...
                  <Link href="/explorer" className="px-4 py-2 bg-[#10B981] text-white text-xs font-bold rounded-xl flex items-center gap-1">
